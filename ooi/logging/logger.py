...
class _ScopedLogger(object):
    ...
    def _install_logger(self):
        ...
        if frame and frame[0]:
            ...
            print("true_caller_tuple = %s", true_caller_tuple)
        logger = logging.getLogger(name)
        print("_install_logger: logging.getLogger name = %s", name)
        ...
        def first_time_find_caller():
            ...
            print("first_time_find_caller: true_caller_tuple = %s", true_caller_tuple)
        ...
        if module:
            module.log = logger
            print("_install_logger: module.log = logger")
        return logger
